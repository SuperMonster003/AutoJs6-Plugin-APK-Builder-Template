...
* `Hint` First release on the independent plugin version line; Plugin Center uses compat-matrix.json to select a paired ABI build, manual downloads should match the autojs6- host suffix, and remote builds remain disabled by default
