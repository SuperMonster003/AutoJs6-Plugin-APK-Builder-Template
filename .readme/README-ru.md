...
* `Улучшение` Удален переключатель сборки `enableRemoteBuild`; плагин всегда объявляет возможность сборки APK
* `Улучшение` Подняты compileSdk и targetSdk до 37 (Android 17); поведение плагина не зависит от нового целевого уровня
* `Улучшение` Пересобрать все пять ABI Runtime Kit для AutoJs6 6.8.0 сборки 5282 с явным диапазоном совместимости хоста
