...
* `Улучшено` Расширить предварительную проверку архивов проекта и сборки до 262144 записей, 4 GiB в сжатом виде, 2 GiB на запись, 8 GiB после распаковки и степени сжатия 2000:1
